...
```
$ globalsmile@ubuntu:~/0x11$ ./0-hbtn_status.py | cat -e
Body response:$
    - type: <class 'bytes'>$
    - content: b'OK'$
    - utf8 content: OK$
$ globalsmile@ubuntu:~/0x11$ 
```
...
```
$ globalsmile@ubuntu:~/0x11$ ./1-hbtn_header.py https://intranet.hbtn.io
...
```
$ globalsmile@ubuntu:~/0x11$ ./2-post_email.py http://0.0.0.0:5000/post_email hr@holbertonschool.com
...
```
$ globalsmile@ubuntu:~/0x11$ ./3-error_code.py http://0.0.0.0:5000
Index
$ globalsmile@ubuntu:~/0x11$ ./3-error_code.py http://0.0.0.0:5000/status_401
Error code: 401
$ globalsmile@ubuntu:~/0x11$ ./3-error_code.py http://0.0.0.0:5000/doesnt_exist
Error code: 404
$ globalsmile@ubuntu:~/0x11$ ./3-error_code.py http://0.0.0.0:5000/status_500
Error code: 500
$ globalsmile@ubuntu:~/0x11$
```
...
```
$ globasmile@ubuntu:~/0x11$ ./4-hbtn_status.py | cat -e
Body response:$
    - type: <class 'str'>$
    - content: OK$
$ globalsmile@ubuntu:~/0x11$
...
```
$ globalsmile@ubuntu:~/0x11$ ./5-hbtn_header.py https://intranet.hbtn.io
...
```
$ globalsmile@ubuntu:~/0x11$ ./6-post_email.py http://0.0.0.0:5000/post_email hr@holbertonschool.com
Your email is: hr@holbertonschool.com
$ globalsmile@ubuntu:~/0x11$
```
...
```
$ globasmile@ubuntu:~/0x11$ ./7-error_code.py http://0.0.0.0:5000
Index
$ globalsmile@ubuntu:~/0x11$ ./7-error_code.py http://0.0.0.0:5000/status_401
Error code: 401
$ globasmile@ubuntu:~/0x11$ ./7-error_code.py http://0.0.0.0:5000/doesnt_exist
Error code: 404
$ globalsmile@ubuntu:~/0x11$ ./7-error_code.py http://0.0.0.0:5000/status_500
Error code: 500
$ globalsmile@ubuntu:~/0x11$
```
...
```
$ globalsmile@ubuntu:~/0x11$ ./8-json_api.py 
No result
$ globalsmile@ubuntu:~/0x11$ ./8-json_api.py a
[8446] amnirqhtfjq
$ globalsmile@ubuntu:~/0x11$ ./8-json_api.py 2
No result
$ globalsmile@ubuntu:~/0x11$ ./8-json_api.py b
[7094] bmofakakhke
$ globalsmile@ubuntu:~/0x11$
```
...
```
$ globalsmile@ubuntu:~/0x11$ ./10-my_github.py monoprosito random_pwd
6069359
$ globalsmile@ubuntu:~/0x11$ ./10-my_github.py monoprosito wrong_pwd
None
$ globasmile@ubuntu:~/0x11$
```
...
```
$ globalsmile@ubuntu:~/0x11$ ./100-github_commits.py rails rails
...
**Solution:** [103-search_twitter.py](./103-search_twitter.py)

```
$ globalsmile@ubuntu:~/0x11$ ./103-search_twitter.py CONSUMER_KEY CONSUMER_SECRET_KEY "#github"
