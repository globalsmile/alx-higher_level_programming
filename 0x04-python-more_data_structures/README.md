...
```
$ guillaume@ubuntu:~/CPython$ python3 --version
Python 3.4.3
$ guillaume@ubuntu:~/CPython$ gcc -Wall -Werror -Wextra -pedantic -std=c99 -shared -Wl,-soname,libPython.so -o libPython.so -fPIC -I/usr/include/python3.4 103-python.c
$ guillaume@ubuntu:~/CPython$ cat 103-tests.py 
import ctypes
...
$ guillaume@ubuntu:~/CPython$ python3 103-tests.py 
[.] bytes object info
  size: 5
  trying string: Hello
